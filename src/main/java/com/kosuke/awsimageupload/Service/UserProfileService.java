package com.kosuke.awsimageupload.Service;
...
import com.kosuke.awsimageupload.model.UserProfileDetail;
import com.kosuke.awsimageupload.repository.UserProfileDataAccessService;
...
public class UserProfileService {
	...
	public List<UserProfile> getUserProfiles() {
		 UserProfile userProfile = userProfileDataAccessService.findAll().stream()
		 	.findFirst()
		 	.orElse(null);
		 userProfile.getUserProfileDetail().forEach(System.out::println);
